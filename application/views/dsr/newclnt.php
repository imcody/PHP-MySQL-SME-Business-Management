    ...
    <div class="span12">
        <div class="widget">
            <div class="widget-header">
                <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span>Register new DSR
                </div>
            </div>
            <div class="widget-body">
                <?php notification(); ?>
                <form class="form-horizontal no-margin" action="<?php echo site_url('dsr/new')?>" method="post">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls controls-row">
                            <input class="span12" type="number" name="cl_balance" placeholder="DSR Opening Balance" />
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="form-actions no-margin">
                        ...
                        <input type="hidden" name="cl_type" value="2" />
                        <button type="submit" class="btn btn-info">Register DSR</button>
                        <a href="<?php echo site_url('dsr/list'); ?>" class="btn btn-default">Back to List</a>
