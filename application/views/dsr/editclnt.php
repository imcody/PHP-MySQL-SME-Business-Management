    ...
    <div class="span12">
        <div class="widget">
            <div class="widget-header">
                <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span>Update DSR
                </div>
            </div>
            <div class="widget-body">
                <?php notification(); ?>
                <form class="form-horizontal no-margin" action="<?php echo site_url('dsr/update');?>" method="post">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls controls-row">
                            <input type="checkbox" name="visible" id="visible" <?php if($detls->visible == 1) { echo 'checked'; } else if($detls->visible == 0) { echo ''; } ?> />
                        </div>
                    </div>
                    <div class="form-actions no-margin">
                        <input type="hidden" name="trigger" value="updateclient">
                        <input type="hidden" name="clid" value="<?php echo $detls->cl_id;?>">
                        <button type="submit" class="btn btn-info">Update DSR Info</button>
