...
//                                    } ?>
            ...
            <div class="widget-body center-align-text">
                ...
                <a href="<?php echo site_url("employee/salaryposting?func=salary&cat=employee&mod=admin&sess_auth=" . md5(date("Ymdhis")) . "&remote=" . md5("autosol") . "&cl_id=" . $employeed_id);?>" class="btn btn-secondary">Salary Posting</a>
            </div>
        </div>
    </div>
</div>