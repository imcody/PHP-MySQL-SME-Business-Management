    ...
    <div class="span12">
        <div class="widget">
            ...
            <div class="widget-body">
                ...
                <div class="span3 form-inline">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input name="closing_date" id="closing_date" readonly="readonly" class="span12" type="text" value="<?php echo date('Y-m-d') ?>" />
                        </div>
                    </div>
                </div>
                <div class="clearfix"></div>
            ...
            <div class="widget-body center-align-text">
                <h4>Today: <?php echo date('dS M, Y'); ?></h4>
                <a type="button" class="btn btn-success" onclick="return MarkStockClosing()">Stock Closing</a>
                <h3>The stock closing action can only be performed once a day & this is un-editable, so please double check before you perform this action finally.</h3>
                <div class="clearfix"></div>                
            </div>
            <?php } ?>
...
<script type="text/javascript">
    function MarkStockClosing(){
        var r = confirm('Are you sure to proceed??\nThe stock closing action can only be performed once a day & this is un-editable, so please double check before you perform this action finally.');
        if(r){
            var dateObj = $("#closing_date").val();
            var link = "<?php echo site_url('order/stockclose?closedon='); ?>" + dateObj;
